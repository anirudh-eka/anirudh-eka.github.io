...
var quotes = (function() {
  ...
  var getNewQuote = function(currentQuote, callback) {
    var newQuote = allQuotes[Math.floor(Math.random()*allQuotes.length)]
    console.log("currentQuote:" + currentQuote)
    console.log("newQuote:" + newQuote.text)
    if (newQuote.text != currentQuote) {
      callback(newQuote);
    } else {
      getNewQuote(currentQuote);
    }
  }

  var replaceQuote = function(quote) {
  ...
  var setup = function() {
    var loop = function(){
      $("#quote").fadeOut(500, function() {
          var quote = getNewQuote($("#quote-text").text(), {callback: replaceQuote, complete: );
      });
    } 
  }
