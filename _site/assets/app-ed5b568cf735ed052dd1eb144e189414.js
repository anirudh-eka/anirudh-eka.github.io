...
Transit = {
	var __makeIndividualScenes = function(scenes, els){
	...
	getScenes: function(name) {
		...
		if(els != undefined) {
			__makeIndividualScenes(scenes, els)		
		}
		...
		scenes.add = function(otherScenes) {
